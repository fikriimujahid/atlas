...
export default function Login() {
  ...
  const { googleSignIn, status } = useAuth();
  ...
  return (
    <div className="flex min-h-[calc(100vh-3.5rem)] flex-col justify-center items-center py-12 px-4 sm:px-6 lg:px-8 bg-muted/20">
      <SEO title="Sign In" description="Sign in to your JSON-AI account." />
      ...
      <Card className="w-full max-w-sm">
        <CardHeader className="space-y-1 text-center pb-4">
          ...
          <CardTitle className="text-2xl font-bold tracking-tight">Welcome to JSON-AI</CardTitle>
